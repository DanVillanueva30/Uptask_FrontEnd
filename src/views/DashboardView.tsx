...
export default function DashboardView() {
    ...
    const { data, isLoading, } = useQuery({
        queryKey: ['projects'], //Esta llave es única para cada query que se haga.
        queryFn: getProjects
    });
    ...
    if (data && user) return (
        <>
            ...
            <nav className="my-10">
                <Link
                    className="bg-purple-400 hover:bg-purple-500 px-10 py-3 text-white text-xl fornt-bold cursor-pointer transition-colors"
                    to="/projects/create"
                > Nuevo Proyecto </Link>
            </nav>
